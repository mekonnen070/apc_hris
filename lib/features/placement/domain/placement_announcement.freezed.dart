...
/// Adds pattern-matching-related methods to [PlacementAnnouncement].
extension PlacementAnnouncementPatterns on PlacementAnnouncement {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PlacementAnnouncement value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PlacementAnnouncement() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PlacementAnnouncement value)  $default,){
final _that = this;
switch (_that) {
case _PlacementAnnouncement():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PlacementAnnouncement value)?  $default,){
final _that = this;
switch (_that) {
case _PlacementAnnouncement() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int announcementId,  String announcementTitle,  String location,  String department,  String positionId,  int requiredExperience,  PlacementEducation requiredEducation,  int requiredApplicants,  DateTime createdDate,  String createdBy,  DateTime expiryDate,  bool budgeted,  ApplicantStatus announcementStatus)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlacementAnnouncement() when $default != null:
return $default(_that.announcementId,_that.announcementTitle,_that.location,_that.department,_that.positionId,_that.requiredExperience,_that.requiredEducation,_that.requiredApplicants,_that.createdDate,_that.createdBy,_that.expiryDate,_that.budgeted,_that.announcementStatus);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int announcementId,  String announcementTitle,  String location,  String department,  String positionId,  int requiredExperience,  PlacementEducation requiredEducation,  int requiredApplicants,  DateTime createdDate,  String createdBy,  DateTime expiryDate,  bool budgeted,  ApplicantStatus announcementStatus)  $default,) {final _that = this;
switch (_that) {
case _PlacementAnnouncement():
return $default(_that.announcementId,_that.announcementTitle,_that.location,_that.department,_that.positionId,_that.requiredExperience,_that.requiredEducation,_that.requiredApplicants,_that.createdDate,_that.createdBy,_that.expiryDate,_that.budgeted,_that.announcementStatus);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int announcementId,  String announcementTitle,  String location,  String department,  String positionId,  int requiredExperience,  PlacementEducation requiredEducation,  int requiredApplicants,  DateTime createdDate,  String createdBy,  DateTime expiryDate,  bool budgeted,  ApplicantStatus announcementStatus)?  $default,) {final _that = this;
switch (_that) {
case _PlacementAnnouncement() when $default != null:
return $default(_that.announcementId,_that.announcementTitle,_that.location,_that.department,_that.positionId,_that.requiredExperience,_that.requiredEducation,_that.requiredApplicants,_that.createdDate,_that.createdBy,_that.expiryDate,_that.budgeted,_that.announcementStatus);case _:
  return null;
