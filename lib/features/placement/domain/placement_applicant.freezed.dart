...
/// Adds pattern-matching-related methods to [PlacementApplicant].
extension PlacementApplicantPatterns on PlacementApplicant {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PlacementApplicant value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PlacementApplicant() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PlacementApplicant value)  $default,){
final _that = this;
switch (_that) {
case _PlacementApplicant():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PlacementApplicant value)?  $default,){
final _that = this;
switch (_that) {
case _PlacementApplicant() when $default != null:
return $default(_that);case _:
