...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String typeId,  String typeName,  int minimumLeave,  int increment,  int incrementingByYear,  int maximumLeave,  bool enabled,  String entryBy,  DateTime entryDate,  List<dynamic> leaves)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LeaveType() when $default != null:
return $default(_that.typeId,_that.typeName,_that.minimumLeave,_that.increment,_that.incrementingByYear,_that.maximumLeave,_that.enabled,_that.entryBy,_that.entryDate,_that.leaves);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String typeId,  String typeName,  int minimumLeave,  int increment,  int incrementingByYear,  int maximumLeave,  bool enabled,  String entryBy,  DateTime entryDate,  List<dynamic> leaves)  $default,) {final _that = this;
switch (_that) {
case _LeaveType():
return $default(_that.typeId,_that.typeName,_that.minimumLeave,_that.increment,_that.incrementingByYear,_that.maximumLeave,_that.enabled,_that.entryBy,_that.entryDate,_that.leaves);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String typeId,  String typeName,  int minimumLeave,  int increment,  int incrementingByYear,  int maximumLeave,  bool enabled,  String entryBy,  DateTime entryDate,  List<dynamic> leaves)?  $default,) {final _that = this;
switch (_that) {
case _LeaveType() when $default != null:
return $default(_that.typeId,_that.typeName,_that.minimumLeave,_that.increment,_that.incrementingByYear,_that.maximumLeave,_that.enabled,_that.entryBy,_that.entryDate,_that.leaves);case _:
  return null;
