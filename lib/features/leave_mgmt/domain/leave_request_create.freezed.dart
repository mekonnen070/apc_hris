...
/// Adds pattern-matching-related methods to [LeaveRequestCreate].
extension LeaveRequestCreatePatterns on LeaveRequestCreate {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LeaveRequestCreate value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LeaveRequestCreate() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LeaveRequestCreate value)  $default,){
final _that = this;
switch (_that) {
case _LeaveRequestCreate():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LeaveRequestCreate value)?  $default,){
final _that = this;
switch (_that) {
case _LeaveRequestCreate() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String leaveTypeId,  String employeeId,  DateTime startDate,  DateTime endDate,  int numOfDays,  String requestReason,  DateTime requestDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LeaveRequestCreate() when $default != null:
return $default(_that.leaveTypeId,_that.employeeId,_that.startDate,_that.endDate,_that.numOfDays,_that.requestReason,_that.requestDate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String leaveTypeId,  String employeeId,  DateTime startDate,  DateTime endDate,  int numOfDays,  String requestReason,  DateTime requestDate)  $default,) {final _that = this;
switch (_that) {
case _LeaveRequestCreate():
return $default(_that.leaveTypeId,_that.employeeId,_that.startDate,_that.endDate,_that.numOfDays,_that.requestReason,_that.requestDate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String leaveTypeId,  String employeeId,  DateTime startDate,  DateTime endDate,  int numOfDays,  String requestReason,  DateTime requestDate)?  $default,) {final _that = this;
switch (_that) {
case _LeaveRequestCreate() when $default != null:
return $default(_that.leaveTypeId,_that.employeeId,_that.startDate,_that.endDate,_that.numOfDays,_that.requestReason,_that.requestDate);case _:
  return null;
