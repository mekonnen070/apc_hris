...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? leaveRequestId,  String leaveTypeId,  String employeeId,  DateTime startDate,  DateTime endDate,  int numOfDays,  String? requestReason,  DateTime requestDate,  LeaveRequestStatus requestStatus,  String? comment,  DateTime? actionedDate,  String? approvedBy,  String? rejectedBy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LeaveRequest() when $default != null:
return $default(_that.leaveRequestId,_that.leaveTypeId,_that.employeeId,_that.startDate,_that.endDate,_that.numOfDays,_that.requestReason,_that.requestDate,_that.requestStatus,_that.comment,_that.actionedDate,_that.approvedBy,_that.rejectedBy);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? leaveRequestId,  String leaveTypeId,  String employeeId,  DateTime startDate,  DateTime endDate,  int numOfDays,  String? requestReason,  DateTime requestDate,  LeaveRequestStatus requestStatus,  String? comment,  DateTime? actionedDate,  String? approvedBy,  String? rejectedBy)  $default,) {final _that = this;
switch (_that) {
case _LeaveRequest():
return $default(_that.leaveRequestId,_that.leaveTypeId,_that.employeeId,_that.startDate,_that.endDate,_that.numOfDays,_that.requestReason,_that.requestDate,_that.requestStatus,_that.comment,_that.actionedDate,_that.approvedBy,_that.rejectedBy);case _:
  throw StateError('Unexpected subclass');
