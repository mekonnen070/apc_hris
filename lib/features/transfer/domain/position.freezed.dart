...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String designationId,  String designationName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Position() when $default != null:
return $default(_that.designationId,_that.designationName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String designationId,  String designationName)  $default,) {final _that = this;
switch (_that) {
case _Position():
return $default(_that.designationId,_that.designationName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String designationId,  String designationName)?  $default,) {final _that = this;
switch (_that) {
case _Position() when $default != null:
return $default(_that.designationId,_that.designationName);case _:
  return null;
