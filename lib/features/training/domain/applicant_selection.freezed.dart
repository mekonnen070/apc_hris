...
/// Adds pattern-matching-related methods to [ApplicantSelection].
extension ApplicantSelectionPatterns on ApplicantSelection {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ApplicantSelection value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ApplicantSelection() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ApplicantSelection value)  $default,){
final _that = this;
switch (_that) {
case _ApplicantSelection():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ApplicantSelection value)?  $default,){
final _that = this;
switch (_that) {
case _ApplicantSelection() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  int? applicationId,  String? applicantId,  int? trainingId,  bool? disciplineStatus,  String? disciplineDescription,  bool? trainingStatus,  String? trainingDescription,  bool? experience,  String? experienceDescription,  bool? retirementStatus,  String? retirementDescription,  bool? medicalStatus,  String? medicalDescription,  ApplicantStatus? selectedStatus,  String? entryBy,  DateTime? entryDate,  TrainingApplicant? applicant)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApplicantSelection() when $default != null:
return $default(_that.id,_that.applicationId,_that.applicantId,_that.trainingId,_that.disciplineStatus,_that.disciplineDescription,_that.trainingStatus,_that.trainingDescription,_that.experience,_that.experienceDescription,_that.retirementStatus,_that.retirementDescription,_that.medicalStatus,_that.medicalDescription,_that.selectedStatus,_that.entryBy,_that.entryDate,_that.applicant);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  int? applicationId,  String? applicantId,  int? trainingId,  bool? disciplineStatus,  String? disciplineDescription,  bool? trainingStatus,  String? trainingDescription,  bool? experience,  String? experienceDescription,  bool? retirementStatus,  String? retirementDescription,  bool? medicalStatus,  String? medicalDescription,  ApplicantStatus? selectedStatus,  String? entryBy,  DateTime? entryDate,  TrainingApplicant? applicant)  $default,) {final _that = this;
switch (_that) {
case _ApplicantSelection():
return $default(_that.id,_that.applicationId,_that.applicantId,_that.trainingId,_that.disciplineStatus,_that.disciplineDescription,_that.trainingStatus,_that.trainingDescription,_that.experience,_that.experienceDescription,_that.retirementStatus,_that.retirementDescription,_that.medicalStatus,_that.medicalDescription,_that.selectedStatus,_that.entryBy,_that.entryDate,_that.applicant);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  int? applicationId,  String? applicantId,  int? trainingId,  bool? disciplineStatus,  String? disciplineDescription,  bool? trainingStatus,  String? trainingDescription,  bool? experience,  String? experienceDescription,  bool? retirementStatus,  String? retirementDescription,  bool? medicalStatus,  String? medicalDescription,  ApplicantStatus? selectedStatus,  String? entryBy,  DateTime? entryDate,  TrainingApplicant? applicant)?  $default,) {final _that = this;
switch (_that) {
case _ApplicantSelection() when $default != null:
return $default(_that.id,_that.applicationId,_that.applicantId,_that.trainingId,_that.disciplineStatus,_that.disciplineDescription,_that.trainingStatus,_that.trainingDescription,_that.experience,_that.experienceDescription,_that.retirementStatus,_that.retirementDescription,_that.medicalStatus,_that.medicalDescription,_that.selectedStatus,_that.entryBy,_that.entryDate,_that.applicant);case _:
  return null;
