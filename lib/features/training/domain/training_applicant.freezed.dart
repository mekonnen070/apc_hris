...
/// Adds pattern-matching-related methods to [TrainingApplicant].
extension TrainingApplicantPatterns on TrainingApplicant {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TrainingApplicant value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TrainingApplicant() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TrainingApplicant value)  $default,){
final _that = this;
switch (_that) {
case _TrainingApplicant():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TrainingApplicant value)?  $default,){
final _that = this;
switch (_that) {
case _TrainingApplicant() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String applicantId,  int appliedFor,  ApplicantStatus? applicantStatus,  double? cgpa,  int age,  String? applicantEntryBy,  DateTime? applicantEntryDate,  EmployeeInfoModel? employee,  Training? training, @JsonKey(includeFromJson: false, includeToJson: false)  List<ApplicantSelection?> applicantSelections)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrainingApplicant() when $default != null:
return $default(_that.id,_that.applicantId,_that.appliedFor,_that.applicantStatus,_that.cgpa,_that.age,_that.applicantEntryBy,_that.applicantEntryDate,_that.employee,_that.training,_that.applicantSelections);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  String applicantId,  int appliedFor,  ApplicantStatus? applicantStatus,  double? cgpa,  int age,  String? applicantEntryBy,  DateTime? applicantEntryDate,  EmployeeInfoModel? employee,  Training? training, @JsonKey(includeFromJson: false, includeToJson: false)  List<ApplicantSelection?> applicantSelections)  $default,) {final _that = this;
switch (_that) {
case _TrainingApplicant():
return $default(_that.id,_that.applicantId,_that.appliedFor,_that.applicantStatus,_that.cgpa,_that.age,_that.applicantEntryBy,_that.applicantEntryDate,_that.employee,_that.training,_that.applicantSelections);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  String applicantId,  int appliedFor,  ApplicantStatus? applicantStatus,  double? cgpa,  int age,  String? applicantEntryBy,  DateTime? applicantEntryDate,  EmployeeInfoModel? employee,  Training? training, @JsonKey(includeFromJson: false, includeToJson: false)  List<ApplicantSelection?> applicantSelections)?  $default,) {final _that = this;
switch (_that) {
case _TrainingApplicant() when $default != null:
return $default(_that.id,_that.applicantId,_that.appliedFor,_that.applicantStatus,_that.cgpa,_that.age,_that.applicantEntryBy,_that.applicantEntryDate,_that.employee,_that.training,_that.applicantSelections);case _:
  return null;
