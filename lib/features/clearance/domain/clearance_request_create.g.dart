...
_ClearanceRequestCreate _$ClearanceRequestCreateFromJson(
  ...
  clearanceStatus:
      $enumDecodeNullable(_$ClearanceStatusEnumMap, json['clearanceStatus']) ??
      ClearanceStatus.pending,
  remarks: json['remarks'] as String?,
);

Map<String, dynamic> _$ClearanceRequestCreateToJson(
  _ClearanceRequestCreate instance,
) => <String, dynamic>{
