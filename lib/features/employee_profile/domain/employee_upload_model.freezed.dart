...
/// Adds pattern-matching-related methods to [EmployeeUploadModel].
extension EmployeeUploadModelPatterns on EmployeeUploadModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EmployeeUploadModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _EmployeeUploadModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EmployeeUploadModel value)  $default,){
final _that = this;
switch (_that) {
case _EmployeeUploadModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EmployeeUploadModel value)?  $default,){
final _that = this;
switch (_that) {
case _EmployeeUploadModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? documentId,  String employeeId,  String documentName,  DocumentType documentType,  String? description,  String? filePath, @JsonKey(includeFromJson: false, includeToJson: false)  File? documentFile,  DateTime? expiryDate,  bool isActive,  String? uploadedBy,  DateTime? uploadDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EmployeeUploadModel() when $default != null:
return $default(_that.documentId,_that.employeeId,_that.documentName,_that.documentType,_that.description,_that.filePath,_that.documentFile,_that.expiryDate,_that.isActive,_that.uploadedBy,_that.uploadDate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? documentId,  String employeeId,  String documentName,  DocumentType documentType,  String? description,  String? filePath, @JsonKey(includeFromJson: false, includeToJson: false)  File? documentFile,  DateTime? expiryDate,  bool isActive,  String? uploadedBy,  DateTime? uploadDate)  $default,) {final _that = this;
switch (_that) {
case _EmployeeUploadModel():
return $default(_that.documentId,_that.employeeId,_that.documentName,_that.documentType,_that.description,_that.filePath,_that.documentFile,_that.expiryDate,_that.isActive,_that.uploadedBy,_that.uploadDate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? documentId,  String employeeId,  String documentName,  DocumentType documentType,  String? description,  String? filePath, @JsonKey(includeFromJson: false, includeToJson: false)  File? documentFile,  DateTime? expiryDate,  bool isActive,  String? uploadedBy,  DateTime? uploadDate)?  $default,) {final _that = this;
switch (_that) {
case _EmployeeUploadModel() when $default != null:
return $default(_that.documentId,_that.employeeId,_that.documentName,_that.documentType,_that.description,_that.filePath,_that.documentFile,_that.expiryDate,_that.isActive,_that.uploadedBy,_that.uploadDate);case _:
  return null;
