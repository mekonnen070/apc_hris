...
const _$EducationLevelEnumMap = {
  ...
  EducationLevel.secondarySchoolFirstCycle: 'secondarySchoolFirstCycle',
  EducationLevel.secondarySchoolSecondCycle: 'secondarySchoolSecondCycle',
  EducationLevel.tvet: 'tvet',
  EducationLevel.certificate: 'certificate',
  EducationLevel.diploma: 'diploma',
  EducationLevel.advancedDiploma: 'advancedDiploma',
  EducationLevel.bachelorsDegree: 'bachelorsDegree',
  EducationLevel.bachelorsDegreeFiveYear: 'bachelorsDegreeFiveYear',
  EducationLevel.llbDegree: 'llbDegree',
  EducationLevel.mdDegree: 'mdDegree',
  EducationLevel.pharmDDegree: 'pharmDDegree',
  EducationLevel.postgraduateDiploma: 'postgraduateDiploma',
  EducationLevel.mastersDegree: 'mastersDegree',
  EducationLevel.mba: 'mba',
  EducationLevel.llm: 'llm',
  EducationLevel.specialtyCertificate: 'specialtyCertificate',
  EducationLevel.doctorOfMedicineSpecialty: 'doctorOfMedicineSpecialty',
  EducationLevel.phD: 'phD',
  EducationLevel.associateDegree: 'associateDegree',
  EducationLevel.highSchoolDiploma: 'highSchoolDiploma',
...
const _$EducationStatusEnumMap = {
  EducationStatus.inProgress: 'inProgress',
  EducationStatus.completed: 'completed',
  EducationStatus.onHold: 'onHold',
  EducationStatus.fraud: 'fraud',
};
