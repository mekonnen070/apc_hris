...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PersonalInfo? personalInfo,  List<AcademicQualification> academicQualifications,  List<WorkExperience> workExperiences, @JsonKey(includeFromJson: false, includeToJson: false)  File? cvFile, @JsonKey(includeFromJson: false, includeToJson: false)  File? nationalIdFile,  List<GeneralDocument> otherDocuments)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RegistrationFormData() when $default != null:
return $default(_that.personalInfo,_that.academicQualifications,_that.workExperiences,_that.cvFile,_that.nationalIdFile,_that.otherDocuments);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PersonalInfo? personalInfo,  List<AcademicQualification> academicQualifications,  List<WorkExperience> workExperiences, @JsonKey(includeFromJson: false, includeToJson: false)  File? cvFile, @JsonKey(includeFromJson: false, includeToJson: false)  File? nationalIdFile,  List<GeneralDocument> otherDocuments)  $default,) {final _that = this;
switch (_that) {
case _RegistrationFormData():
return $default(_that.personalInfo,_that.academicQualifications,_that.workExperiences,_that.cvFile,_that.nationalIdFile,_that.otherDocuments);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PersonalInfo? personalInfo,  List<AcademicQualification> academicQualifications,  List<WorkExperience> workExperiences, @JsonKey(includeFromJson: false, includeToJson: false)  File? cvFile, @JsonKey(includeFromJson: false, includeToJson: false)  File? nationalIdFile,  List<GeneralDocument> otherDocuments)?  $default,) {final _that = this;
switch (_that) {
case _RegistrationFormData() when $default != null:
return $default(_that.personalInfo,_that.academicQualifications,_that.workExperiences,_that.cvFile,_that.nationalIdFile,_that.otherDocuments);case _:
  return null;
