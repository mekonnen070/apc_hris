...
/// Adds pattern-matching-related methods to [EmployeeDependantModel].
extension EmployeeDependantModelPatterns on EmployeeDependantModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _EmployeeDependantModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _EmployeeDependantModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _EmployeeDependantModel value)  $default,){
final _that = this;
switch (_that) {
case _EmployeeDependantModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _EmployeeDependantModel value)?  $default,){
final _that = this;
switch (_that) {
case _EmployeeDependantModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? dependantId,  String employeeId,  String dependantFullName,  RelationTypes relation,  Gender gender,  DateTime birthDate,  String? occupation,  EthiopianRegion region,  String? zone,  String? woreda,  String? kebele,  String? houseNumber,  String phoneNumber,  String? alternatePhoneNumber,  String? email,  bool enabled,  String? entryBy,  DateTime? entryDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EmployeeDependantModel() when $default != null:
return $default(_that.dependantId,_that.employeeId,_that.dependantFullName,_that.relation,_that.gender,_that.birthDate,_that.occupation,_that.region,_that.zone,_that.woreda,_that.kebele,_that.houseNumber,_that.phoneNumber,_that.alternatePhoneNumber,_that.email,_that.enabled,_that.entryBy,_that.entryDate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? dependantId,  String employeeId,  String dependantFullName,  RelationTypes relation,  Gender gender,  DateTime birthDate,  String? occupation,  EthiopianRegion region,  String? zone,  String? woreda,  String? kebele,  String? houseNumber,  String phoneNumber,  String? alternatePhoneNumber,  String? email,  bool enabled,  String? entryBy,  DateTime? entryDate)  $default,) {final _that = this;
switch (_that) {
case _EmployeeDependantModel():
return $default(_that.dependantId,_that.employeeId,_that.dependantFullName,_that.relation,_that.gender,_that.birthDate,_that.occupation,_that.region,_that.zone,_that.woreda,_that.kebele,_that.houseNumber,_that.phoneNumber,_that.alternatePhoneNumber,_that.email,_that.enabled,_that.entryBy,_that.entryDate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? dependantId,  String employeeId,  String dependantFullName,  RelationTypes relation,  Gender gender,  DateTime birthDate,  String? occupation,  EthiopianRegion region,  String? zone,  String? woreda,  String? kebele,  String? houseNumber,  String phoneNumber,  String? alternatePhoneNumber,  String? email,  bool enabled,  String? entryBy,  DateTime? entryDate)?  $default,) {final _that = this;
switch (_that) {
case _EmployeeDependantModel() when $default != null:
return $default(_that.dependantId,_that.employeeId,_that.dependantFullName,_that.relation,_that.gender,_that.birthDate,_that.occupation,_that.region,_that.zone,_that.woreda,_that.kebele,_that.houseNumber,_that.phoneNumber,_that.alternatePhoneNumber,_that.email,_that.enabled,_that.entryBy,_that.entryDate);case _:
  return null;
